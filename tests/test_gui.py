...
class AutomaticTesting(GuiTestingHandler):
    def launch_gui_testing(
        self, exclude=None, force_build=False, run_slower=False, os_type="windows"
    ):
    ...
    def set_folder_name(self):
        ...
        self.folder = os.path.join(
            os.path.dirname(__file__), "gui_testing_files", calling_function_name
        )
        ...
        with open(self.events, "r") as f:
            ...
            for l in lines:
                ...
                #      exec('self.gui.canvas.event_generate('+l+',warp=True)', globals(), locals())
                    ...
                    exec(
                        "self.gui.canvas.event_generate(" + l + ")", globals(), locals()
                    )
